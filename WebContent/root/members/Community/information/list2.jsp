...
<%
	...
	pageContext.setAttribute("total", infoDao.getSize(""));
%>
                        ...
                        <table id="free-board-table">
                            ...
                            <tbody>
                            	<c:forEach var="inf" items="${list}">	
                            		<tr>
                            			<td class="free-board-cell num"><a class="board-list-item-text">${inf.code}</td>
										<td class="free-board-cell title"><a class="board-list-item-text" href="view.jsp?c=${inf.code}">${inf.title}</a></td>
										<td class="free-board-cell writer"><a class="board-list-item-text" >${inf.writer}</a></td>
										<td class="free-board-cell date"><a class="board-list-item-text">${inf.regdate}</a></td>
										<td class="free-board-cell hit"><a class="board-list-item-text">${inf.hit}</a></td>
										<td class="free-board-cell recommend"><a class="board-list-item-text">${inf.thumb}</a></td>
									</tr>	
								</c:forEach>
